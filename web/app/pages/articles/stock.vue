            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div class="flex items-center gap-3">
                ...
                <div class="space-y-0.5">
                  ...
                  <p class="text-muted text-xs">Récupération des prix Cardmarket / PokéWallet (plus lent).</p>
                </div>
              </div>
              <p class="text-muted max-w-sm text-xs sm:text-right">Désactivez pour une liste plus rapide.</p>
            </div>
            <div
              class="border-default flex flex-col gap-4 border-t pt-4 sm:flex-row sm:items-center sm:justify-between"
            >
              <div class="flex items-center gap-3">
