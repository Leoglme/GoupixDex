  ...
  <div ref="rootRef" class="relative w-full">
    ...
    <component :is="teleportToBody ? Teleport : 'div'" :to="teleportToBody ? 'body' : undefined">
      ...
      >
        ...
        <li v-else-if="suggestions.length === 0" class="text-muted px-3 py-2 text-sm">Aucune adresse trouvée</li>
        <template v-else>
          <li
          ...
          >
            <span class="text-highlighted font-medium">{{ suggestion.label }}</span>
          </li>
        </template>
      </ul>
    </component>
...
import type { AddressSuggestion, AddressAutocompleteInputProps } from '~/types/AddressAutocompleteInput'
...
const props = withDefaults(defineProps<AddressAutocompleteInputProps>(), {
